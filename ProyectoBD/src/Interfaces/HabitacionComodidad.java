...
public class HabitacionComodidad extends javax.swing.JFrame {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        int[]  Habitacion = tabla4.getSelectedRows();
        for(int i: Habitacion)
        control.InsertarHC(Integer.parseInt(tabla4.getValueAt(i, 0).toString()), Integer.parseInt(tabla5.getValueAt(tabla5.getSelectedRow(), 0).toString()), Integer.parseInt(tabla4.getValueAt(i, 3).toString()));        // TODO add your handling code here:
