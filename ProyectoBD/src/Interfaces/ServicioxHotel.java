 ...
 * @author Owner
 */
public class ServicioxHotel extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    Controladora control;
    public ServicioxHotel() {
        initComponents();
        ...
        lista = control.ObtenerLista(control.ConsultarGeneral(control.GenerarCondicionConsulta("servicio_7", "", "", "", "", "", "")),1);
        for (String nombre : lista) {
            comboPaquete.addItem(nombre);
        }
        lista = control.ObtenerLista(control.ConsultarGeneral(control.GenerarCondicionConsulta("personal_7", "Encargado", "", "", "", "", "")),1);
        for (String nombre : lista) {
            comboEncargado.addItem(nombre);
        }
    }
    ...
    private void initComponents() {
        ...
        textEncargado1 = new javax.swing.JTextField();
        ...
        jLabel9.setText("Capacidad de la piscina:");
        ...
        panelCrearLayout.setHorizontalGroup(
            ...
            .addGroup(panelCrearLayout.createSequentialGroup()
                ...
                .addGroup(panelCrearLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelCrearLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(panelCrearLayout.createSequentialGroup()
                            .addGroup(panelCrearLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelCrearLayout.createSequentialGroup()
                            .addGroup(panelCrearLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(textCapacidad, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addContainerGap()))
                ...
                .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelModificarLayout.createSequentialGroup()
                        ...
                        .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textEncargado1, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelModificarLayout.createSequentialGroup()
                        ...
                        .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(textEncargado1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if(textTipo.getText().toString().equals("Piscina")){
        control.InsertarHotelServicio(Double.parseDouble(textCosto.getText()), Integer.parseInt(control.ConsultaPrimaria("Codigo", "servicio_7", "Descripcion", comboPaquete.getSelectedItem().toString())),Integer.parseInt(control.ConsultaPrimaria("Codigo", "hotel_7", "Nombre", comboHotel.getSelectedItem().toString())), textTipo.getText(), Integer.parseInt(textCapacidad.getText()),control.ConsultaPrimaria("CI", "personal_7", "Nombre", comboEncargado.getSelectedItem().toString()));
        }
        else
            control.InsertarHotelServicio(Double.parseDouble(textCosto.getText()), Integer.parseInt(control.ConsultaPrimaria("Codigo", "servicio_7", "Descripcion", comboPaquete.getSelectedItem().toString())),Integer.parseInt(control.ConsultaPrimaria("Codigo", "hotel_7", "Nombre", comboHotel.getSelectedItem().toString())), textTipo.getText(), 0,control.ConsultaPrimaria("CI", "personal_7", "Nombre", comboEncargado.getSelectedItem().toString()));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        tabla1.setModel(control.ConsultaServicioHotel(control.GenerarCondicionSelect("", "", "", "", "", ""), comboHotel1.getSelectedItem().toString()));
// TODO add your handling code here:
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
       if(!textEncargado1.getText().equals("")){
            tabla1.setModel(control.ConsultaServicioHotel(control.GenerarCondicionSelect("Costo", "CI", "", textCosto1.getText(), control.ConsultaPrimaria("CI", "personal_7", "concat(Nombre,'',Apellido)", textEncargado1.getText()), ""), comboHotel1.getSelectedItem().toString()));   
        }
       else
         tabla1.setModel(control.ConsultaServicioHotel(control.GenerarCondicionSelect("Costo", "CI", "", textCosto1.getText(),"",""), comboHotel1.getSelectedItem().toString()));
        
        textCosto1.setText("");
        textEncargado1.setText("");// TODO add your handling code here:
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        tabla1.setModel(control.ConsultaServicioHotel(control.GenerarCondicionSelect("", "", "", "", "", ""), comboHotel1.getSelectedItem().toString()));  // TODO add your handling code here:
              textCosto1.setText("");
        textEncargado1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicioxHotel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServicioxHotel().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField textEncargado1;
