...
public class Servicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textTarifa1 = new javax.swing.JTextField();
        ...
        jLabel6.setText("Equipo especial:");

        comboEquipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Si", "No" }));
                    ...
                    .addGroup(panelCrear1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelCrear1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panelCrear1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(textDescripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
        ...
        jLabel7.setText("Equipo Especial:");

        comboEquipo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Si", "No" }));
                    ...
                    .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(panelModificarLayout.createSequentialGroup()
                            .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(textDescripcion1, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGap(18, 18, 18)
                            .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(panelModificarLayout.createSequentialGroup()
                                    .addComponent(jLabel5)
                                    .addGap(0, 0, Short.MAX_VALUE))
                                .addComponent(textTarifa1))
                            .addGap(18, 18, 18)
                            .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelModificarLayout.createSequentialGroup()
                        ...
                        .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(textTarifa1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(comboEquipo1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(24, 24, 24))
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        DefaultTableModel modelo = control.ConsultarGeneral(control.GenerarCondicionConsulta("Servicio_7","Codigo", "", "",tabla1.getValueAt(tabla1.getSelectedRow(), 0).toString() ,"",""));
        ...
        textTarifa.setText(modelo.getValueAt(0, 3).toString());// TODO add your handling code here:
    }//GEN-LAST:event_jButton12ActionPerformed

    private void IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarActionPerformed
        boolean Equipo = true;
        if(comboEquipo.getSelectedItem().toString().equals("Si"))
            Equipo = true;
        else if(comboEquipo.getSelectedItem().toString().equals("No"))
            Equipo = false;
        control.InsertarServicio(textDescripcion.getText(),Equipo,Double.parseDouble(textTarifa.getText())); 
        textDescripcion.setText("");
        textTarifa.setText("");// TODO add your handling code here:
    }//GEN-LAST:event_IngresarActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        tabla1.setModel(control.ConsultarGeneral(control.GenerarCondicionConsulta("servicio_7", "", "", "", "", "", "")));
        control.activarPanel(panelModificar, panelCrear1); // TODO add your handling code here:
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        control.EliminarGeneral(control.GenerarCondicionDelete("servicio_7", "Codigo", "", "", tabla1.getValueAt(tabla1.getSelectedRow(), 0).toString(), "", "")); 
        tabla1.setModel(control.ConsultarGeneral(control.GenerarCondicionConsulta("servicio_7", "", "", "", "", "", "")));  // TODO add your handling code here:
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        int Equipo = 1;
        if(comboEquipo1.getSelectedItem().toString().equals("Si"))
            Equipo = 1;
        else if(comboEquipo1.getSelectedItem().toString().equals("No"))
            Equipo = 0;
       tabla1.setModel( control.ConsultarGeneral(control.GenerarCondicionConsulta("servicio_7", "Descripcion", "Tarifa", "Equipo_Especial", textDescripcion1.getText(), textTarifa1.getText(), String.valueOf(Equipo))));   
       textDescripcion1.setText("");
       textTarifa1.setText("");// TODO add your handling code here:
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        ...
        if(comboEquipo.getSelectedItem().toString().equals("Si"))
            ...
            Equipo = false;
        control.ModificarServicio(textDescripcion.getText(),Equipo,Double.parseDouble(textTarifa.getText()), codigo);
        Guardar.setEnabled(false);
    ...
    private javax.swing.JTextField textTarifa1;
