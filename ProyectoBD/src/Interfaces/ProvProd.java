 ...
 * @author Owner
 */
public class ProvProd extends javax.swing.JFrame {
    ...
    public ProvProd() {
        ...
        tabla4.setModel(control.ConsultaProducto(control.GenerarCondicionSelect("", "", "", "", "", "")));
        tabla5.setModel(control.ConsultaProveedor(control.GenerarCondicionSelect("", "", "", "", "", "")));
    }
    ...
    private void initComponents() {
                ...
                .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelModificarLayout.createSequentialGroup()
                        .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textProducto1, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(29, 29, 29)
                        .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel6)
                            .addComponent(textProveedor1, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(100, 100, 100)
        ...
        panelModificarLayout.setVerticalGroup(
            ...
            .addGroup(panelModificarLayout.createSequentialGroup()
                .addGap(12, 12, 12)
                .addComponent(Tabla1, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(panelModificarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelModificarLayout.createSequentialGroup()
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        control.InsertarPP(Integer.parseInt(tabla4.getValueAt(tabla4.getSelectedRow(), 0).toString()), tabla5.getValueAt(tabla5.getSelectedRow(), 0).toString());        // TODO add your handling code here:
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        control.activarPanel(panelModificar, panelCrear);
         tabla1.setModel(control.ConsultaPP(control.GenerarCondicionSelect("CodigoP", "RIF", "", "", "", "")));// TODO add your handling code here:
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        if(textProducto1.getText().equals("") && textProveedor1.getText().equals(""))
               tabla1.setModel(control.ConsultaPP(control.GenerarCondicionSelect("CodigoP", "RIF", "", "", "", ""))); 
        else if(textProducto1.getText().equals("") && !textProveedor1.getText().equals(""))
             tabla1.setModel(control.ConsultaPP(control.GenerarCondicionSelect("CodigoP", "RIF", "", "", control.ConsultaPrimaria("RIF", "compañia_7", "Nombre", textProveedor1.getText()), ""))); 
        else if(!textProducto1.getText().equals("") && textProveedor1.getText().equals(""))
                tabla1.setModel(control.ConsultaPP(control.GenerarCondicionSelect("CodigoP", "RIF", "", control.ConsultaPrimaria("Codigo", "producto_implemento_7", "Nombre", textProducto1.getText()), "", ""))); 
        else  
        tabla1.setModel(control.ConsultaPP(control.GenerarCondicionSelect("CodigoP", "RIF","", control.ConsultaPrimaria("Codigo", "producto_implemento_7", "Nombre", textProducto1.getText()), control.ConsultaPrimaria("RIF", "compañia_7", "Nombre", textProveedor1.getText()), ""))); 
        textProducto1.setText("");
        textProveedor1.setText("");// TODO add your handling code here:
    }//GEN-LAST:event_jButton14ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        control.EliminarGeneral(control.GenerarCondicionDelete("pp_7", "CodigoP", "RIF", "", tabla1.getValueAt(tabla1.getSelectedRow(), 0).toString(), "'"+tabla1.getValueAt(tabla1.getSelectedRow(), 2).toString()+"'", ""));
         tabla1.setModel(control.ConsultaPP(control.GenerarCondicionSelect("CodigoP", "RIF", "", "", "", "")));// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProvProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
