...
public class Controladora {
    ...
    public void activarPanel3(JPanel panelA, JPanel panelB, JPanel panelC, JPanel panelD, JPanel panelE, JPanel panelF){
        panelA.setVisible(true);
        panelB.setVisible(false);
        panelC.setVisible(false);
        panelD.setVisible(false);
 ...
 public void GenerarReporte3(int numeroO, String fechaOrden, String cantidad,String fechaPago, String nombreC, String nombreH, String costo){
   ...
   public DefaultTableModel RevisarPagoOren(String codigoH){
    ...
    public void ModificarPersonal(String ci,String nombre, String apellido, String calle, String edificio, String urbanizacion, char sexo, Date fechaNac, Date fechaInicio, String cargo, String nivelEstudio, int codigoH, int codigoL,boolean despedido, String ciSupervisor){
     ...
     public void ModificarPaquete(String Nombre, String descripcion, int codigo){
        Paquete p = new Paquete(Nombre,descripcion,codigo);
        dato.ModificarPaquete(p);
    }
...
//        } 
    ...
    public void InsertarHabitacion(int cantidad, String tipo, int codigoH, double Costo, int Cantidad){
        Habitacion h;
        for (int i = 0; i < cantidad;i++) {
            h = new Habitacion(0,tipo,true,codigoH,Costo,Cantidad);
   ...
   public void ModificarHabitacion(int numero,String tipo, boolean disponible, int codigoH, double Costo, int Cantidad){
        Habitacion h = new Habitacion(numero,tipo,disponible,codigoH,Costo,Cantidad);
...
public DefaultTableModel ConsultaCompra(String condicion){
    ...
    public void InsertarPaquete(String Nombre, String descripcion){
        Paquete p = new Paquete(Nombre,descripcion);
        dato.InsertarPaquete(p);
        
    }
    
public void ModificarServicio(String Descripcion, boolean EquipoEspecial, double Tarifa, int codigo){
        Servicio s = new Servicio(Descripcion,EquipoEspecial,Tarifa,codigo);
        dato.ModificarServicio(s);
    }
    
    public void InsertarHP(int codigoP,int codigoH, double costo, int cupos){
        HP hp = new HP(codigoP,codigoH, costo,cupos);
        dato.InsertarHP(hp);
    }
    public void ModificarHP(int codigoP,int codigoH, double costo, int cupos){
        HP hp = new HP(codigoP,codigoH, costo,cupos);
        dato.ModificarHP(hp);
    }
   
    public void InsertarServicio(String Descripcion, boolean EquipoEspecial, double Tarifa){
        Servicio s = new Servicio(Descripcion,EquipoEspecial,Tarifa);
        dato.InsertarServicio(s);
        
    }
    
    public void ModificarServicio(String Descripcion, boolean EquipoEspecial, double Tarifa){
        Servicio s = new Servicio(Descripcion,EquipoEspecial,Tarifa);
        dato.ModificarServicio(s);
    }

public void InsertarHotelServicio(double costo, int codigoS, int codigoH, String tipoServicio, int capacidad, String ci){
        HotelServicio hs = new HotelServicio(costo,codigoS,codigoH,tipoServicio,capacidad,ci);
        dato.InsertarHotelServicio(hs);
        
    }

    public void InsertarPaqueteReserva(double costo, int codigoR, int codigoP, int codigoH){
        PaqueteReserva pr = new PaqueteReserva(costo,codigoR,codigoP,codigoH);
        dato.InsertarPaqueteReserva(pr);
    }

    public void InsertarServicioReserva(int codigoS,  int codigoH, int codigoR, double costo){
        ServicioReserva sr = new ServicioReserva(codigoS,codigoH,codigoR,costo);
        dato.InsertarServicioReserva(sr);
    }
    
 public void InsertarCompra(int codigo, Date fechaI, Date fechaF, int codigoR, int añoIngreso, int consecutivo){
        Compra c = new Compra(codigo,fechaI,fechaF,codigoR,añoIngreso,consecutivo);
    }
    
    public void InsertarPago(double monto, String tipoPago, Date fechaPago, int codigoC){
        Pago pa = new Pago(monto,tipoPago,fechaPago,codigoC);
        dato.InsertarPago(pa);
    }
    
    public DefaultTableModel ConsultaPago(String condicion, int codigoC){
      return dato.ConsultaPago(condicion,codigoC);
    }
    
public void InsertarReserva(int codigo,int consecutivo, Date fechaReserva, Date fechaInicio, Date fechaFinal, int añoIngreso){
        Reserva r = new Reserva(codigo,consecutivo,fechaReserva,fechaInicio,fechaFinal,añoIngreso);
        dato.InsertarReserva(r);
    }
    
    public void CalcularMontoTotalReserva(int codigoR){
        dato.CalcularMontoTotalReserva(codigoR);
    }
    
    public void CalcularMontoTotalCompra(int codigoC){
        dato.CalcularMontoTotalCompra(codigoC);
    }
    
    public void AgregarCompra(int CodigoR){
        dato.AgregarCompra(CodigoR);
    }
    
    public void InsertarHR(int numero, int codigoR, int codigoH, double costo){
        HR hr = new HR(numero,codigoR,codigoH,costo);
        dato.InsertarHR(hr);
    }
    
    public void InsertarRA(int codigoR, String ci){
        RA ra = new RA(codigoR,ci);
        dato.InsertarRA(ra);
    }
    public void InsertarCH(int numero, int codigoC, int codigoHH, int costo){
        CH ch = new CH(numero,codigoC,codigoHH,costo);
        dato.InsertarCH(ch);
    }
    public void InsertarCA(int codigoC, String ci){
        CA ca = new CA(codigoC,ci);
        dato.InsertarCA(ca);
    }
    
    public void InsertarPaqueteCompra(int codigoC, int codigoHPH, int codigoHPP, double costo, int tipo){
        PaqueteCompra pc = new PaqueteCompra(codigoC,codigoHPH, codigoHPP, costo);
        dato.InsertarPaqueteCompra(pc,tipo);
    }
    public void InsertarServicioCompra(int codigoC, int codigoHS, int codigoS, double costo){
        ServicioCompra sc = new ServicioCompra(codigoC,codigoHS, codigoS, costo);
        dato.InsertarServicioCompra(sc);
    }
